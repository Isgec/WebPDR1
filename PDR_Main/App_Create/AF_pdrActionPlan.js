...
var script_pdrActionPlan = {
    ...
    validate_PDRNo: function(sender) {
      ...
      this.validated_FK_PDR_Actions_PDRNo_main = true;
      this.validate_FK_PDR_Actions_PDRNo(sender,Prefix);
      },
    ...
    validate_FK_PDR_Actions_PDRNo: function(o,Prefix) {
      var value = o.id;
      var PDRNo = $get(Prefix + 'PDRNo');
      if(PDRNo.value==''){
        if(this.validated_FK_PDR_Actions_PDRNo_main){
      ...
      value = value + ',' + PDRNo.value ;
        ...
        PageMethods.validate_FK_PDR_Actions_PDRNo(value, this.validated_FK_PDR_Actions_PDRNo);
      },
    validated_FK_PDR_Actions_PDRNo_main: false,
    validated_FK_PDR_Actions_PDRNo: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_pdrActionPlan.validated_FK_PDR_Actions_PDRNo_main){
