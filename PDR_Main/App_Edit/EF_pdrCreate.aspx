<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_pdrCreate.aspx.vb" Inherits="EF_pdrCreate" title="Edit: Create and Submit PDR" %>
<asp:Content ID="CPHpdrCreate" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelpdrCreate" runat="server" Text="&nbsp;Edit: Create and Submit PDR"></asp:Label>
</div>
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "pdrCreateGetByID"
  UpdateMethod="pdrCreateUpdate"
  DeleteMethod="pdrCreateDelete"
