<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="False" CodeFile="GF_pdrReview.aspx.vb" Inherits="GF_pdrReview" title="Maintain List: Review and Action Plan" %>
<asp:Content ID="CPHpdrReview" ContentPlaceHolderID="cph1" Runat="Server">
<div class="ui-widget-content page">
<div class="caption">
    <asp:Label ID="LabelpdrReview" runat="server" Text="&nbsp;List: Review and Action Plan"></asp:Label>
</div>
<div class="pagedata">
<asp:UpdatePanel ID="UPNLpdrReview" runat="server">
  <ContentTemplate>
    ...
    <LGM:ToolBar0 
      ID = "TBLpdrReview"
      ToolType = "lgNMGrid"
      EditUrl = "~/PDR_Main/App_Edit/EF_pdrReview.aspx"
      EnableAdd = "False"
      ValidationGroup = "pdrReview"
      runat = "server" />
    <asp:UpdateProgress ID="UPGSpdrReview" runat="server" AssociatedUpdatePanelID="UPNLpdrReview" DisplayAfter="100">
      <ProgressTemplate>
    ...
    <asp:GridView ID="GVpdrReview" SkinID="gv_silver" runat="server" DataSourceID="ODSpdrReview" DataKeyNames="PDRNo">
      <Columns>
...
<%--        <asp:TemplateField HeaderText="PRINT">
        ...
        <asp:TemplateField HeaderText="Freeze Action Plan">
          <ItemTemplate>
            <asp:ImageButton ID="cmdInitiateWF" ValidationGroup='<%# "Initiate" & Container.DataItemIndex %>' CausesValidation="true" runat="server" Visible='<%# EVal("InitiateWFVisible") %>' Enabled='<%# EVal("InitiateWFEnable") %>' AlternateText='<%# EVal("PrimaryKey") %>' ToolTip="Freeze Action Plan" SkinID="forward" OnClientClick='<%# "return Page_ClientValidate(""Initiate" & Container.DataItemIndex & """) && confirm(""Freeze Action Plan ?"");" %>' CommandName="InitiateWF" CommandArgument='<%# Container.DataItemIndex %>' />
          </ItemTemplate>
          <ItemStyle CssClass="alignCenter" />
          <HeaderStyle CssClass="alignCenter" Width="30px" />
        </asp:TemplateField>
<%--        <asp:TemplateField HeaderText="Reject">
    ...
    <asp:ObjectDataSource 
      ...
      SelectMethod = "UZ_pdrReviewSelectList"
      TypeName = "SIS.PDR.pdrReview"
      SelectCountMethod = "pdrReviewSelectCount"
  ...
  <Triggers>
    <asp:AsyncPostBackTrigger ControlID="GVpdrReview" EventName="PageIndexChanged" />
